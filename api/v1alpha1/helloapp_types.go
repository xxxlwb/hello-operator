...
type HelloAppStatus struct {
	...
	// conditions represent the current state of the HelloApp resource.
...
type HelloApp struct {
	...
	// spec defines the desired state of HelloApp
	// +required
	Spec HelloAppSpec `json:"spec"`

	// status defines the observed state of HelloApp
	// +optional
	Status HelloAppStatus `json:"status,omitzero"`
}
